...
let 我的优选TXT = ["https://raw.githubusercontent.com/ImLTHQ/edge-tunnel/main/Domain.txt", "https://raw.githubusercontent.com/ImLTHQ/edge-tunnel/main/HK.txt"];
...
function clash配置文件(hostName) {
  ...
  const 代理配置 = 生成节点(我的优选)
    ...
    .join("\n");
  const CF规则 = 启用反代功能 ? [] : ["  - GEOIP,CLOUDFLARE,DIRECT,no-resolve", "  - GEOSITE,cloudflare,DIRECT", "  - DOMAIN-KEYWORD,cloudflare,DIRECT"];
  return `
proxies:
${节点配置}
proxy-groups:
